...
// Add dynamic gradient effect on hover
const profile = document.querySelector('.home-profile');

profile.addEventListener('mouseenter', () => {
    profile.style.background = `linear-gradient(135deg, ${getRandomColor()}, ${getRandomColor()})`;
});

profile.addEventListener('mouseleave', () => {
    profile.style.background = 'linear-gradient(135deg, #ff7eb3, #ff758c)';
});
